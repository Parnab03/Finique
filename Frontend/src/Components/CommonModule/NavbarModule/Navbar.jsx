...
import Light_mode_logo from "../NavbarModule/assets/Logo_light_mode.svg";
    ...
    return (
        <nav className="bg-white border-b border-slate-200">
            <div className="flex items-center justify-between gap-0">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="relative pl-2">
                            <button
                                ...
                                className="flex items-center gap-1.5 text-xs font-semibold text-blue-600 bg-blue-50 px-3 py-1.5 rounded hover:bg-blue-100 transition-colors">
                                {selectedRole}
                                <svg
                                    className="w-4 h-4"
                                    fill="currentColor"
                            ...
                            {roleOpen && (
                                <div className="absolute top-full mt-1 w-32 bg-white border border-slate-200 rounded-lg shadow-lg z-50">
                                    <button
                                        onClick={() => {
                    ...
                    <div className="flex items-center gap-3 ml-auto">
                        <div className="relative flex-1 max-w-sm">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-blue-300 transition-colors"
                            />
                        </div>
                ...
                {/* Right - User profile */}
                <div className="flex items-center h-10 gap-3 flex-shrink-0 px-6 py-4 border-l border-slate-200">
