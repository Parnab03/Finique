...
const SignUp = () => {
    ...
    const [step, setStep] = useState(1); // 1: Admin creation, 2: Success
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            ...
            const result = signup(adminName.trim(), adminPassword);
    ...
    const handleCreateViewer = () => {
        navigate("/settings?createViewer=true");
    };
                        ...
                        <>
                            ...
                            <div
                                ...
                                <p>
                                    ...
                                    You can create a Viewer account from
                                    Settings after signing in to use read-only
                                    access.
                                </p>
                            </div>
                            ...
                            {/* Sign In Link */}
                            <div
                                className={`text-center mt-5 sm:mt-6 text-xs sm:text-sm ${
                                    isDarkMode
                                        ? "text-slate-400"
                                        : "text-slate-600"
                                }`}>
                        ...
                        <>
                            ...
                            <div className="text-center">
                                ...
                                <p
                                    ...
                                    Your admin account has been set up
                                    successfully.
                                </p>
                                ...
                                <div
                                    ...
                                    <p className="text-left">
                                        ...
                                        You can create a Viewer account from
                                        Settings after signing in to use
                                        read-only access,{" "}
                                        <span className="font-semibold">
                                            or create one now
                                        </span>
                                ...
                                <div className="space-y-3">
                                    <button
                                        ...
                                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 sm:py-3 rounded-lg transition-all duration-200">
                                        Go to Dashboard
                                    </button>
                                    <button
                                        type="button"
                                        onClick={handleCreateViewer}
                                        className={`w-full py-2.5 sm:py-3 rounded-lg font-semibold transition-all border ${
                                            isDarkMode
